...
const FeatureSection = () => (
  <section className={tw(`bg-white dark:bg-gray-900 pb-6`)}>
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
      <div className={tw(`container mx-auto px-6 p-6 bg-white dark:bg-gray-900`)}>
        <div className={tw(`mb-16 text-center`)}>
          <h4 className={tw(`text-base text-indigo-600 font-semibold tracking-wide uppercase`)}>Features</h4>
          <p className={tw(`mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900 dark:text-gray-100`)}>
        ...
        <div className={tw(`flex flex-wrap my-12`)}>
          ...
          >
            ...
            <p className={tw(`leading-loose text-gray-500 dark:text-gray-400`)}>
